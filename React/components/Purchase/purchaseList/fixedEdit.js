        ...
        return(
            <div id = 'fixed_edit' className = {value.fixedEditShow?'':'fixed_edit_hide'}>
        	    <div className = "fixed_edit_wraper">
        	         <h2 className = 'fixed_edit_title'>编辑设备采购</h2>
        	         <ul className = 'fixed_edit_content'>
        	             <table cellspacing = "0">
        	                  ...
        	                  <tr>
	    	                      <td className = 'label'>所属类目：</td>
		                          <td>
		                              <input type = 'text' name = 'cat_name' ref = 'cat_name' value = {data.cat_name?data.cat_name:''} onChange = {this.inputChange.bind(this , 'cat_name' ,dispatch)}></input>
		                          </td>
	    	                      <td>创建时间:</td>
		                          <td>
	                                  {data.update_time} 
    	                      ...
    	                      <tr>
    	                          <td className = 'label'>采购数量：</td>
		                          <td>
		                              <input type = 'text' name = 'num' ref = 'num' value = {data.num} onChange = {this.inputChange.bind(this , 'num' ,dispatch)}></input>
		                              <input type = 'text' name = 'unit' ref = 'unit' value = {data.unit} onChange = {this.inputChange.bind(this , 'unit' ,dispatch)}></input>
		                          </td>
	    	                      <td>联系电话:</td>
		                          <td>
	                          ...
	                          <tr>
	    	                      <td className = 'label'>到期时间：</td>
		                          <td>
		                              <input type = 'text' name = 'deadline' ref = 'deadline' value = {data.deadline?data.deadline:''} onChange = {this.inputChange.bind(this , 'deadline' ,dispatch)}></input>
		                          </td>
	    	                      <td>需求金额:</td>
		                          <td>
        	                  ...
        	                  <tr>
	        	                  <td colSpan = '4'>
		        	                  <a className = 'btn' href = 'javascript:;' onClick = {() => {dispatch(actions.purchaseEdit())}}>确认</a>
