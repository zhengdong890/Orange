...
import actions from '../../../actions/News/noticeUpdate';
        ...
        return(		
	        <div className = 'block_edit'>		                    	   
	            <table>
		            ...
		            <tr>
			            <td className = 'td_label'>图标路径:</td>
			            <td>
			                <input type = 'text' name = 'img_url' ref = 'img_url' value = {data.img_url?data.img_url:''} onChange = {this.inputChange.bind(this , 'img_url' ,dispatch)}></input>
			            </td>
		            </tr> 
	                <tr>
