...
var UPDATE_URL = '/index.php/Admin/goods/goodsUpdate.html';
/* *
 * 表单
 * */
	...
	render(){	
        ...
        return(
            <tr>
	            ...
	            <td className='table_td'><a>审核</a></td>
		...
		data.map(function(v , index){  
            ...
            table_list.push( 
                <tr key = {index}>
                   ...
                   <td className='table_td'>{v.goods_name}</td>
                   <td className='table_td'>{v.goods_code}</td>
                   <td className='table_td'>
                   ...
                   <td className='table_td'> 
	                   <a href={'/index.php/Admin/goods/goodsCheck.html'+'?id='+v.id}>
