...
class pageView extends React.Component{
	render(){	
        ...
        var page_data = value.data_page;
        /*初次获取数据*/
        if(value.data_page.totalRows === ''){
        	dispatch(actions.getData(1,{'firstRow':0,'listRows':page_data.listRows}));
        }
        /*分页处理*/
