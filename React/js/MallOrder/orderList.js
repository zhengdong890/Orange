class CashClass{
	constructor() {
        this.tableData   = [];
        this.fixed_table_data = [];
        
        this.fixed_table_show = false;
	...
	getData(){
		return{
		    ...
		    'fixed_table_data' : this.fixed_table_data[this.order_id]?this.fixed_table_data[this.order_id]:[],
		    
		    'fixed_table_show' : this.fixed_table_show,	    
