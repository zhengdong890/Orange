...
use Think\Model;
class MallGoodsSeoModel extends Model{
    protected $tableName='Mall_goods_seo';
    /**
     * 商品seo添加
     * @access public
