...
use Think\Model;
class TenderSelectModel extends Model{
  protected $tableName='Tender_select'; //关闭检测字段
  ...
  public function selectDelete($id){ 
       ...
       $r = M('Tender_select')->where(array('id'=>$id))->delete();
       if($r === false){
          $result = array(
              'status' => 0,
              'msg'    => '删除失败'
